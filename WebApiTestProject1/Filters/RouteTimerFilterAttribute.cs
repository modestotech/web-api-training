...
namespace WebApiTestProject1.Filters
{
    ...
    public class RouteTimerFilterAttribute : ActionFilterAttribute
    {
        ...
        public override async Task OnActionExecutingAsync(HttpActionContext actionContext, CancellationToken cancellationToken)
        {
            ...
            {
                // If no name is passed in, take the action name from the actionContext object
        ...
        public override async Task OnActionExecutedAsync(HttpActionExecutedContext actionExecutedContext, CancellationToken cancellationToken)
        {
            ...
            // The response is available, so add it to the Headers
